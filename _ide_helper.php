...
')
     ...
     */ 
         ...
         * 
         *
         * @param \DefStudio\Telegraph\array<int|\DefStudio\Telegraph\string,  string|bool> $permissions
         * @static 
         */ 
         ...
         * 
         *
         * @param \DefStudio\Telegraph\array<array-key,  array<array-key, array{text: string, url?: string, callback_data?: string, web_app?: string[]}>>|Keyboard|callable(Keyboard):Keyboard $keyboard
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function replyWebhook($callbackQueryId, $message)
        {
                        /** @var \DefStudio\Telegraph\Telegraph $instance */
                        return $instance->replyWebhook($callbackQueryId, $message);
        }
                    /**
         * 
         *
         * @param \DefStudio\Telegraph\array<string,  mixed> $data
         * @return \DefStudio\Telegraph\array<string, mixed>
         * @static 
         */ 
        ...
        {
                        /** @var \DefStudio\Telegraph\Telegraph $instance */
                        return $instance->getFileInfo($file_id);
        }
                    /**
         * 
         *
         ...
         * 
         *
         * @param \DefStudio\Telegraph\Support\Testing\Fakes\array<string,  string> $data
         * @static 
         */ 
        public static function assertSentData($endpoint, $data = [], $exact = true)
        {
                        /** @var \DefStudio\Telegraph\Support\Testing\Fakes\TelegraphFake $instance */
                        return $instance->assertSentData($endpoint, $data, $exact);
        }
                    /**
         * 
         *
